...
def f_dyn_rk2(R0, A0, v0, w0, q, qd, F0, T0, Fe, Te, tau):
    ...
    tmp_vd0, tmp_wd0, tmp_qdd, HH, Force0 = f_dyn(R0, A0, v0, w0, q, qd, F0, T0, Fe, Te, tau)
    ...
    tmp_vd0, tmp_wd0, tmp_qdd, HH, Force0 = f_dyn(R0 + k1_R0/2, A0 + k1_A0/2, v0 + k1_v0/2, w0 + k1_w0/2, q + k1_q/2, qd + k1_qd/2, F0, T0, Fe, Te, tau)
    ...
    tmp_vd0, tmp_wd0, tmp_qdd, HH, Force0 = f_dyn(R0 + k2_R0/2, A0 + k2_A0/2, v0 + k2_v0/2, w0 + k2_w0/2, q + k2_q/2, qd + k2_qd/2, F0, T0, Fe, Te, tau)
    ...
    tmp_vd0, tmp_wd0, tmp_qdd, HH, Force0 = f_dyn(R0 + k3_R0, A0 + k3_A0, v0 + k3_v0, w0 + k3_w0, q + k3_q, qd + k3_qd, F0, T0, Fe, Te, tau)
    ...
    return R0, A0, v0, w0, q, qd, HH, Force0, tmp_vd0, tmp_wd0, tmp_qdd
