...
def calc_pos(R0, A0, AA, q):
    """
    calculate the centroid position of each link
    :param R0: the position of the base
    :param A0: the attitude of the base
    :param AA: direction cosine matrices for all links
    :param q: joint variables
    :return: centroid position for each link
    """
