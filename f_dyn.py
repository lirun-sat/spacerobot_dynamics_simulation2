...
def f_dyn(R0, A0, v0, w0, q, qd, F0, T0, Fe, Te, tau):
    """
    Function: calculate base-satellite and joints accelerations
    Dependency: calc_aa, calc_pos, calc_hh, r_ne
    :param R0:
    :param A0:
    :param v0:
    :param w0:
