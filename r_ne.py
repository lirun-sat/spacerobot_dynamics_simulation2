...
def r_ne(R0, RR, A0, AA, v0, w0, vd0, wd0, q, qd, qdd, Fe, Te):
    """
    Function: Inverse dynamics. Newton-Euler approach for numerical computation of the velocity dependent non-linear terms
    Dependency: calc_vel, calc_acc
    :param R0: position of the centroid of base
    :param RR: position of centroid of each link
    :param A0: attitude of the base
    :param AA: attitude of each link
    :param v0: linear velocity of the base
    :param w0: angular velocity of thr base
    :param vd0: linear acceleration of the base
    :param wd0: angular acceleration of the base
    :param q: the variable of the joints
    :param qd: joints velocity
    :param qdd: joints acceleration
    :param Fe: external force exerted on the end-points
    :param Te: external torque exerted on the end-points
    :return: velocity dependent non-linear terms
    """
